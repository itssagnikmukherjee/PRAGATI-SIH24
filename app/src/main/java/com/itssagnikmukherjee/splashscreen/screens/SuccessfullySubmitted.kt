...
fun ComplaintSubmitted() {
    Column(
        ...
        Column {
        Text("Thank You !", fontSize = 36.sp, fontFamily = outfit, fontWeight = FontWeight.Bold, color = myGrey, modifier = Modifier.height(60.dp))
        Text(text = "Your complaint is submitted to the local councillor", fontFamily = outfit, fontSize = 18.sp, color = myGrey)
